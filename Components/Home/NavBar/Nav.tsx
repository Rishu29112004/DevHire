...
const Nav = ({ openNav }: Props) => {
    ...
    return (
        <div className={`transition-all ${navBg ? 'bg-white dark:bg-gray-900 shadow-md ' : 'fixed'} duration-200 h-[12vh] z-50 fixed w-full`}>
            <div className='flex items-center h-full justify-between w-[92%] mx-auto'>
                ...
                <div className='flex items-center space-x-4'>
                    ...
                    <button className='px-8 py-2.5 text-xs sm:text-sm rounded-lg cursor-pointer bg-gray-100 hover:bg-gray-300 transition-all duration-300 dark:bg-gray-700 dark:hover:bg-gray-900'>Login / Register</button>
                    {/*Job post buttons*/}
