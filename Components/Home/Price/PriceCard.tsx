...
const PriceCard = ({ price, type }: Props) => {
    return (
        ...
        <h1 className='mt-6 text-xl font-bold text-blue-900 dark:text-blue-300'>{type}</h1>
        ...
        <div className='mt-8 text-center'>
            <button className='w-full py-3 bg-blue-900/15 dark:bg-gray-100 text-blue-700 rounded-full hover:bg-blue-700 hover:text-white transition-all durartion-300 cursor-pointer'>View Profile</button>
        </div>
        </div>
    )
}
